...
${getJsonLd(t, course, locales)}
  ...
  <body>
    ...
    <footer>
      <a class="item" href="${SITE}/" aria-label="nmatei.github.io">
        <svg class="icon" viewBox="0 0 24 24" fill="currentColor" width="17" height="17" aria-hidden="true">
          <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"></path>
        </svg>
        <span class="label">nmatei.github.io</span>
      </a>
      <span class="item">|</span>
      <a class="item" href="https://www.linkedin.com/in/nicolaematei" target="_blank" aria-label="LinkedIn">
        <svg
          class="icon"
      ...
      <span class="item">|</span>
      <a class="item" target="_blank" href="${course.url}?referralCode=${course.referralCode}">
        <span class="label">${t.referralLink}</span><span class="label-short">Udemy</span>
      </a>
      <span class="item">|</span>
